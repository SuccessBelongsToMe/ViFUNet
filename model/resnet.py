...
class ResNet(nn.Module):
    def __init__(self,layers,channel,num_class):
        #inplane=当前的fm的通道数
        self.inplane=1
        ...
        #stem的网络层
        self.conv1=nn.Conv2d(channel,self.inplane,kernel_size=7,stride=2,padding=3,bias=False)
